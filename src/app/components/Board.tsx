...
function Board() {
  ...
  return (
    <div  className="flex flex-row gap-4 w-full h-full"> 
      <Column title="Pending" status="todo" tickets={tickets} setTickets={handleSetTickets}/>
      <Column title="Open" status="doing" tickets={tickets} setTickets={handleSetTickets}/>
      <Column title="Closed" status="done" tickets={tickets} setTickets={handleSetTickets}/>
    </div>
  )
}
